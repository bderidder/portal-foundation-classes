...
public class SimpleSecurityServiceController implements IPeerServiceController
{
	private static final Log LOGGER = LogFactory.getLog(SimpleSecurityServiceController.class);

	public void init(IServiceConfig serviceConfig) throws ServiceException
	{
		LOGGER.debug("Configuring ldap security service");

		_simpleSecurityServiceImpl = new SimpleSecurityService();
	}
	...
	{
		return _simpleSecurityServiceImpl;
	}

	private SimpleSecurityService _simpleSecurityServiceImpl;
}