...
public class StateChangedEvent extends EventObject
{
	...
	public StateChangedEvent(Object source, Class<?>[] serviceClasses,
			ServiceState oldState, ServiceState newState)
	{
		super(source);
	...
	private Class<?>[] _serviceClasses;
	private ServiceState _oldState;
	private ServiceState _newState;
}