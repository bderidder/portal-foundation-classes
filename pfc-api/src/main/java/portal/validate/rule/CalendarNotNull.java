...
public class CalendarNotNull extends ValidationRule
{
	private static final long serialVersionUID = 1L;

	public CalendarNotNull(IPropertyModel<Calendar> calendarModel)
	{
	...
	{
		return !(_model.getValue() == null);
	}

	private IPropertyModel<Calendar> _model;
}