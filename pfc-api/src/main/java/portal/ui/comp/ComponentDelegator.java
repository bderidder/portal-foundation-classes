...
public class ComponentDelegator extends Component<IModel>
{
    ...
    @Override
    protected final void draw(IRenderContext pRenderContext) throws RenderException, IOException
    {
        pRenderContext.includeComponent(getComponent());
    }
