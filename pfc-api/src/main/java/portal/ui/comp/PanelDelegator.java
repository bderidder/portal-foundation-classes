...
public class PanelDelegator<ModelType extends IModel> extends Component<ModelType>
{
	private static final long serialVersionUID = 1L;

	public PanelDelegator()
	{
		this(null);
	}

	public PanelDelegator(ModelType model)
	{
		super(model);
	...
	{
		pRenderContext.includeComponent(getContentPanel());
	}

	protected final Panel getContentPanel()
	{
		return _panel;
	}
