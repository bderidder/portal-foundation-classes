 ...
 * 
 * This interface represents a tasks that can be executed at a later time.
 */
public interface IScheduledTask
{
	/**
	 * This method is called by the service when the scheduled time
	 * has passed. In order to prevent the scheduler service of blocking
	 * it is advised not to perform lengthy or blocking operations.
	 */
	void performTask();
}
