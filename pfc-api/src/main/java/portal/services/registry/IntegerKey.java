...
public class IntegerKey extends RegistryKey
{
	public static final String TYPE = "Integer";

	public IntegerKey(String pName, String strValue) throws TypeMismatchException
	{
		super(pName);
		
		try
		{
			this._value = new Integer(strValue);
		}
		catch (Exception e)
		{
	...
	public Integer getInteger() throws RegistryException
	{
		return _value;
	}

	public static Integer getValue(String name) throws RegistryException
	{
		...
		{
			return ((IntegerKey) key).getInteger();
		}
		else
		{
	...
	public static int getValue(String name, int defaultValue)
	{
		try
		{
			return IntegerKey.getValue(name).intValue();
		}
